...
!> @{
      subroutine GFS_MP_generic_post_run(                                                                                 &
        ...
        imp_physics_mg, imp_physics_fer_hires, cal_pre, cplflx, cplchm, cpllnd, cplcat, progsigma, con_g, rhowater, 
        rainmin, dtf, frain, rainc, rain1, rann, xlat, xlon, gt0, gq0, prsl, prsi, phii, tsfc, ice, phil, htop, refl_10cm,& 
        ...
        totprcp, totice, totsnw, totgrp, cnvprcpb, totprcpb, toticeb, totsnwb, totgrpb, rain_cpl, rainc_cpl, rain_cplcat, &
...
!
      ...
      logical, intent(in) :: cal_pre, lssav, ldiag3d, qdiag3d, cplflx, cplchm, cpllnd, cplcat, progsigma, exticeden
...
!          'rain=',Diag%rain(1)
      ...
      if (cplflx .or. cplchm .or. cpllnd .or. cplcat) then
        do i = 1, im
      ...
      if (cplcat) then
        do i = 1, im
          rain_cplcat(i) = rain_cpl(i) + snow_cpl(i)
        enddo
      endif

      if (cplchm .or. cpllnd .or. cplcat) then
        do i = 1, im
