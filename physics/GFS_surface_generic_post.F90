...
!!
      subroutine GFS_surface_generic_post_run (im, cplflx, cplaqm, cplchm, cplwav, cpllnd, cplcat, lssav, dry, icy, wet,            &
        ...
        logical,                                intent(in) :: cplflx, cplaqm, cplchm, cplcat, cplwav, cpllnd, lssav
