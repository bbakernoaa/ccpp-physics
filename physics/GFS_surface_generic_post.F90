...
!!
      subroutine GFS_surface_generic_post_run (im, cplflx, cplaqm, cplchm, cplchp, cplwav, lssav, dry, icy, wet,                    &
        ...
        logical,                                intent(in) :: cplflx, cplaqm, cplchm, cplchp, cplwav, lssav
