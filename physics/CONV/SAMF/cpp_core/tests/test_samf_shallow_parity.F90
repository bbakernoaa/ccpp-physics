program test_samf_shallow_parity
  ...
  print *, "Running test_samf_shallow_parity..."
  call c_samf_shallow_convection_run(int(columns, 8), int(layers, 8), dt, &
      t_lay, q_vap, u_wind, v_wind, p_lay, p_int, z_lay, z_int, &
      dt_t, dt_q, dt_u, dt_v, &
      ud_mf, dt_mf, kbot, ktop)

  print *, "  - dt_t(1, 1) (expected: 0.0): ", dt_t(1, 1)
  print *, "  - kbot(1) (expected: 0):     ", kbot(1)
  print *, "test_samf_shallow_parity PASS!"
end program test_samf_shallow_parity
